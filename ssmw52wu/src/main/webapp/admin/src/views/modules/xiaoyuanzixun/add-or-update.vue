<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="资讯名称" prop="zixunmingcheng">
          <el-input v-model="ruleForm.zixunmingcheng" 
              placeholder="资讯名称" clearable  :readonly="ro.zixunmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="资讯名称" prop="zixunmingcheng">
              <el-input v-model="ruleForm.zixunmingcheng" 
...
export default {
  ...
  methods: {
	...
	this.ruleForm.neirong = this.ruleForm.neirong.replace(reg,'../../../ssmw52wu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
